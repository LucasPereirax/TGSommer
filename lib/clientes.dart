...
import 'package:flutter_application_1/novoCliente.dart';
...
class _ClientesState extends State<Clientes> {
  final _formKey_Clientes = GlobalKey<FormState>();
  final _inputNomeCliente_Cliente = TextEditingController();

  @override
  void initState() {
    super.initState();
    _inputNomeCliente_Cliente.addListener(() {
      setState(() {});
    });
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            controller: _inputNomeCliente_Cliente,
                            autofocus: true,
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon:
                                  _inputNomeCliente_Cliente.text.isNotEmpty
                                      ? IconButton(
                                          icon: Icon(Icons.clear),
                                          onPressed: () {
                                            setState(() {
                                              _inputNomeCliente_Cliente.clear();
                                            });
                                          },
                                        )
                                      : Icon(Icons.search),
